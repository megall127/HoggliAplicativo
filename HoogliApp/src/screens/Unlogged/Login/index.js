...
import { ButtonLogin, ButtonLoginRegister, ImageBackGroundView, ImageHeader, InputLogin, TextButtonLogin, TextButtonRegister, TextViewRegister, ViewAll, ViewGradiente, ViewHeader, ViewInputsLogin, ViewRegister } from "./styled";
           ...
           <LinearGradient start={{x: 0.5, y: 0.10}} end={{x: 0.5, y: 1.0}} colors={['#58934f','#8ecf84','#8ecf84','#8ecf84']}>
               <ViewGradiente>
                   <ViewHeader>
                        ...
                        <ImageBackGroundView source={require('../../../img/FundoVerdeGrande.png')}>
                        </ImageBackGroundView>
                    <ViewInputsLogin>
