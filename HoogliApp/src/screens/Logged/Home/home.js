    ...
    return(
        <ViewAll>
            <ViewSpace>
                ...
                <ViewBackground source={(require('../../../img/FundoVerdeGrande.png'))}>
                </ViewBackground>
